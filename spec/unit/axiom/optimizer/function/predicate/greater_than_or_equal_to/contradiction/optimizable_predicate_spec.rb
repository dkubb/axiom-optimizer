...
describe Optimizer::Function::Predicate::GreaterThanOrEqualTo::Contradiction, '#optimizable?' do
  ...
  before do
    expect(predicate).to be_kind_of(Function::Predicate::GreaterThanOrEqualTo)
  end
