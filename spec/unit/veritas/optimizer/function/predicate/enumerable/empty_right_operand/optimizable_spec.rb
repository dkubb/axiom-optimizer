...
describe Optimizer::Function::Predicate::Enumerable::EmptyRightOperand, '#optimizable?' do
  ...
  before do
    described_class.class_eval { include Optimizer::Function::Predicate::Enumerable::EmptyRightOperand }
